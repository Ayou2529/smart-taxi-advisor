...
# ================= LONGDO TRAFFIC API =================
LONGDO_API_KEY = "YOUR_LONGDO_API_KEY_HERE"  # Get free key from https://map.longdo.com/docs/javascript/getkey
USE_DEMO_TRAFFIC = True  # Set to False when you have real API key
...
def get_traffic_incidents_real():
    ...
    try:
        ...
        return incidents if incidents else get_traffic_incidents_demo()
    except Exception as e:
        print(f"⚠️ Longdo API Error: {e}")
        return get_traffic_incidents_demo()
...
FACEBOOK_ACCESS_TOKEN = "YOUR_FACEBOOK_TOKEN_HERE"  # Get from developers.facebook.com
USE_DEMO_NEWS = True  # Set to False when you have real Facebook token
